...
public class Disposition
{
	...
	)
	{
		...
		this.spin = new Rotation(this.orientation.down, new ReferenceDouble(0));
	...
	{
		return new Disposition(Coords.create(), Orientation.create(), null);
	}

	public static Disposition from2
	(
	...
	{
		return new Disposition(pos, Orientation.create(), null);
	}
