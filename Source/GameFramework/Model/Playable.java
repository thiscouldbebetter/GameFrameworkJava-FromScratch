...
public class Playable implements EntityProperty
{
	...
	public static ControlBase toControlWorldOverlay
	(
	...
	)
	{
		...
		var childControls = new ArrayList<ControlBase>();
		...
		(
			...
			playerVisualBarSize,
			Color.Instances().Red,
			DataBinding.fromGet((Entity c) -> killable.integrity),
			null, // amountThreshold
			DataBinding.fromGet((Entity c) -> killable.integrityMax),
		...
		(
			...
			DataBinding.fromGet((Object c) -> starvable.satiety),
			null, // amountThreshold
			DataBinding.fromGet((Object c) -> starvable.satietyMax),
			null, // fractionBelowWhichToShow
			null, // colorForBorderAsValueBreakGroup
			null // text
		);
		...
		(
			...
			DataBinding.fromGet( (Object c) -> tirable.stamina),
			DataBinding.fromGet( (Object c) -> tirable.staminaMaxRemainingBeforeSleep),
			DataBinding.fromGet( (Object c) -> tirable.staminaMaxAfterSleep),
			null, // fractionBelowWhichToShow
			null, // colorForBorderAsValueBreakGroup
			null // text
		);
